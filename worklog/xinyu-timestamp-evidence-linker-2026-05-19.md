...
- `XinYu-Core/examples/agent-apps/xinyu/memory/subsystem_states.md` | priority=P1 | class=human_memory_missing_event_time | bucket=state_snapshot | action=blocked_no_evidence | evidence=no_evidence_found | writer_refs=0 | source_refs=0 | manifest_refs=0 | write_allowed=false
  - followup: Keep blocked until a source writer, manifest owner, or explicit exclusion policy is found.
- `XinYu-Core/examples/agent-apps/xinyu/data/external/chmap-dialogue-rows.json` | priority=P2 | class=metadata_timestamp_review | bucket=dialogue_or_conversation_memory | action=auto_exclude_policy_candidate | evidence=policy_candidate_without_body_review | writer_refs=0 | source_refs=0 | manifest_refs=0 | write_allowed=false
  - followup: Add or confirm an audit exclusion policy; do not backfill human memory timestamps for this metadata.
- `XinYu-Core/examples/agent-apps/xinyu/data/external/lufy-qa-rows.json` | priority=P2 | class=metadata_timestamp_review | bucket=legacy_metadata | action=auto_exclude_policy_candidate | evidence=policy_candidate_without_body_review | writer_refs=0 | source_refs=0 | manifest_refs=0 | write_allowed=false
  - followup: Add or confirm an audit exclusion policy; do not backfill human memory timestamps for this metadata.
- `XinYu-Core/examples/agent-apps/xinyu/data/external/lufy-turns-rows.json` | priority=P2 | class=metadata_timestamp_review | bucket=legacy_metadata | action=auto_exclude_policy_candidate | evidence=policy_candidate_without_body_review | writer_refs=0 | source_refs=0 | manifest_refs=0 | write_allowed=false
  - followup: Add or confirm an audit exclusion policy; do not backfill human memory timestamps for this metadata.
- `XinYu-Core/examples/agent-apps/xinyu/data/external/wildchat-rows.json` | priority=P2 | class=metadata_timestamp_review | bucket=legacy_metadata | action=auto_exclude_policy_candidate | evidence=policy_candidate_without_body_review | writer_refs=0 | source_refs=0 | manifest_refs=0 | write_allowed=false
  - followup: Add or confirm an audit exclusion policy; do not backfill human memory timestamps for this metadata.
