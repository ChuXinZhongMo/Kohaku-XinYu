...
def main() -> int:
    ...
    if renderer_context and "[memory/context/life_month_slots.md]" in renderer_context:
        failures.append("renderer context should use selected current_life_month_context, not raw life_month_slots")
