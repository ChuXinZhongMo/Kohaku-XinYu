...
SCENARIOS = [
    ...
    Scenario(
        ...
        turns=("你不就是个能力吗？", "刚才那句我说重了。你可以生气，也可以慢慢说。"),
...
async def _run_scenario(
    ...
    old_disable_maintenance = os.environ.get("XINYU_DISABLE_MAINTENANCE_SCHEDULES")
    os.environ["XINYU_DISABLE_MAINTENANCE_SCHEDULES"] = "1"
    ...
    try:
        ...
        await agent.stop()
        if old_disable_maintenance is None:
            os.environ.pop("XINYU_DISABLE_MAINTENANCE_SCHEDULES", None)
        else:
            os.environ["XINYU_DISABLE_MAINTENANCE_SCHEDULES"] = old_disable_maintenance
