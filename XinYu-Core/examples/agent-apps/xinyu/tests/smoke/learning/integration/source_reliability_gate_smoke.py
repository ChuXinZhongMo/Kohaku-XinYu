...
def main() -> int:
    ...
    try:
        ...
        if int(integration_result["ready_candidates"]) < int(integration_result["reliability_ready"]):
            failures.append("source_integration_gate ready_candidates should include reliability-ready candidates")
