...
CASES: list[dict[str, str]] = [
    ...
    {"id": "owner_state_feeling", "kind": "self_state", "text": "状态如何，丫头"},
    {"id": "owner_state_how_feels", "kind": "self_state", "text": "你感觉怎么样"},
    {"id": "delayed_frontend_reply_stuck", "kind": "pressure", "text": "收到消息了，前台显示正在回复，然后就没有然后了？"},
    {"id": "template_complaint_plain", "kind": "pressure", "text": "你这不就是套模板吗"},
    {"id": "no_response_plain", "kind": "pressure", "text": "根本没回我，什么情况"},
