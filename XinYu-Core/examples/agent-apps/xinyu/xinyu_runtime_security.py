...
BRIDGE_RUNTIME_SOURCE_RELS = (
    ...
    "xinyu_bridge_proactive_delivery_routes_ack.py",
    "xinyu_bridge_proactive_delivery_routes_claim.py",
    "xinyu_bridge_proactive_delivery_routes_claim_result.py",
    "xinyu_bridge_proactive_delivery_routes_outbound.py",
    "xinyu_bridge_proactive_delivery_routes_payload.py",
    "xinyu_bridge_proactive_delivery_routes_response.py",
    ...
    "xinyu_bridge_autonomous_thought_rendering.py",
    ...
    "xinyu_bridge_reply_pipeline_payload.py",
    "xinyu_bridge_reply_pipeline_decision.py",
    "xinyu_bridge_reply_pipeline_normalization.py",
