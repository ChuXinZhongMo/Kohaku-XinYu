...
## Long-Term Metrics
- stage11_ready_for_stage12: true
- live_loop_status: pass
- live_loop_required_check_count: 6
- live_loop_passed_required_check_count: 6
- live_loop_required_pass_rate_pct: 100.0
- live_loop_has_recent_sample: true
- live_loop_failing_required_checks: none
- live_loop_failing_required_check_detail: none
...
- v1_canary_error_rate: 0.000
- v1_canary_sample_window_turns: 200
- private_reply_selftest_status: pass
- private_reply_selftest_raw_text_included: false
- private_reply_selftest_visible_reply_included: false
- owner_visible_canary_ready: true
- next_step: stage13_higher_order_self_narrative_can_start
...
- live_loop_required_checks_pass: true
- owner_visible_canary_ready: true
- raw_private_boundary_clean: true
- short_term_recall_window_clean: true
- stable_memory_boundary_clean: true
- stage11_ready_for_stage12: true
