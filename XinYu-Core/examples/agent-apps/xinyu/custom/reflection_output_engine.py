    ...
    for line in body.splitlines():
        ...
        for key in ["topic", "source", "priority"]:
            ...
            if stripped.startswith(prefix):
                ...
                fields[key] = sanitize_visible_text(value) if key == "topic" else value
    return fields
...
def extract_dream_weight(weight_text: str) -> dict[str, str | int | bool]:
    ...
    return {
        ...
        "theme": sanitize_visible_text(extract_value(weight_text, "theme")),
        "residue": sanitize_visible_text(extract_value(weight_text, "residue")),
