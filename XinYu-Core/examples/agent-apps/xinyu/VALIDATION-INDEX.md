...
Use `voice_learning_smoke.py` when validating that owner corrections about GPT味, 中文互联网用词, 写作文, 接待腔 become calibration evidence without stable personality rewrite.
