...
__all__ = (
    "Any",
    "CREATIVE_WRITING_STATE_REL",
    "DesktopXinyuStateDeps",
    "Path",
    "SELF_ACTION_APPROVAL_HANDOFF_REL",
    "SELF_ACTION_APPROVAL_QUEUE_REL",
    "SELF_ACTION_GATEWAY_STATE_REL",
    "SELF_ACTION_PATCH_STATE_REL",
    "SELF_ACTION_PATCH_TASK_MD_REL",
    "_desktop_safe_dict",
    "_snapshot_deps",
    "annotations",
    "as_bool",
    ...
    "desktop_service_event_state",
    "desktop_service_services",
    "desktop_services",
