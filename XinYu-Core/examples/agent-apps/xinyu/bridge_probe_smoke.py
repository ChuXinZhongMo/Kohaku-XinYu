...
def main() -> int:
    ...
    if changed_files:
        ...
        # Runtime readiness can overlap with the live autonomous learning/thought
        # loops. Probe responses still assert diagnostic_no_memory per request;
        # these files are background-maintained sidecars, not probe output.
