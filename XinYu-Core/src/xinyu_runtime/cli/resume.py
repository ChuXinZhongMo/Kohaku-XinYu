...
from xinyu_runtime.cli.run import _resolve_session, _run_agent_rich_cli
from xinyu_runtime.session.resume import (
    detect_session_type,
    resume_agent,
    resume_terrarium,
)
from xinyu_runtime.terrarium.cli import run_terrarium_with_tui
...
def resume_cli(
    ...
    if path is None:
        if query:
            ...
            print("No sessions found in ~/.xinyu/sessions/")
        return 1
