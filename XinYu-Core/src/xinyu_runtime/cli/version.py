...
from xinyu_runtime import __version__


def detect_install_source() -> str:
    """Best-effort detection of how XinYu Runtime is installed."""
    try:
        dist = importlib.metadata.distribution("XinYuTerrariumRuntime")
...
def get_package_version() -> str:
    ...
    try:
        return importlib.metadata.version("XinYuTerrariumRuntime")
    except importlib.metadata.PackageNotFoundError:
        return __version__
