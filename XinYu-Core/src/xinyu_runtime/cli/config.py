...
from xinyu_runtime.cli.config_mcp import add_or_update_mcp, delete_mcp, list_mcp
from xinyu_runtime.cli.config_prompts import confirm as _confirm
from xinyu_runtime.cli.config_prompts import format_profile as _format_profile
from xinyu_runtime.cli.config_prompts import prompt as _prompt
from xinyu_runtime.cli.config_prompts import prompt_choice as _prompt_choice
from xinyu_runtime.cli.config_prompts import prompt_int as _prompt_int
from xinyu_runtime.cli.config_prompts import (
...
from xinyu_runtime.llm.api_keys import KEYS_PATH, list_api_keys, save_api_key
...
from xinyu_runtime.utils.paths import XINYU_HOME
...
def _config_show() -> int:
    paths = _config_paths()
    print("XinYu Runtime config paths")
...
def _llm_list(include_builtins: bool = False) -> int:
    from xinyu_runtime.llm.profiles import list_all
...
def add_config_subparser(subparsers: argparse._SubParsersAction) -> None:
    ...
    parser = subparsers.add_parser(
        "config",
        help="Manage XinYu Runtime configuration (providers, presets, keys, MCP)",
    )
