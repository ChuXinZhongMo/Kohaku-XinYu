"""
Configuration loading and validation for XinYu Runtime agents.
...
from xinyu_runtime.core.config_merge import merge_configs as _merge_configs
from xinyu_runtime.core.config_types import (
    AgentConfig,
    InputConfig,
    OutputConfig,
    OutputConfigItem,
...
from xinyu_runtime.core.output_wiring import parse_wiring_list
