...
from xinyu_runtime.bootstrap.agent_init import AgentInitMixin
from xinyu_runtime.bootstrap.plugins import init_plugins
from xinyu_runtime.core.agent_handlers import AgentHandlersMixin
from xinyu_runtime.core.agent_messages import AgentMessagesMixin
from xinyu_runtime.core.agent_model import AgentModelMixin
from xinyu_runtime.core.budget import IterationBudget
from xinyu_runtime.core.compact import CompactConfig, CompactManager
from xinyu_runtime.core.config import AgentConfig, load_agent_config
from xinyu_runtime.core.controller_plugins import register_plugin_and_package_commands
from xinyu_runtime.core.events import TriggerEvent, create_user_input_event
from xinyu_runtime.core.job import JobState
from xinyu_runtime.core.loader import ModuleLoader
from xinyu_runtime.core.session import Session
from xinyu_runtime.core.termination import TerminationChecker, TerminationConfig
from xinyu_runtime.core.trigger_manager import TriggerManager
from xinyu_runtime.llm.message import ContentPart
...
from xinyu_runtime.session.output import SessionOutput
...
class Agent(AgentInitMixin, AgentHandlersMixin, AgentMessagesMixin, AgentModelMixin):
    ...
    async def _init_mcp(self) -> None:
        ...
        try:
            from xinyu_runtime.mcp.client import MCPClientManager, MCPServerConfig
        except ImportError:
