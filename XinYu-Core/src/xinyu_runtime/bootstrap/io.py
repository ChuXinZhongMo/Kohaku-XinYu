...
:func:`xinyu_runtime.packages.resolve_package_io`. This lets packages ship
...
from xinyu_runtime.builtins.inputs import (
    CLIInput,
    create_builtin_input,
    is_builtin_input,
)
from xinyu_runtime.builtins.outputs import (
    StdoutOutput,
...
from xinyu_runtime.packages import resolve_package_io
