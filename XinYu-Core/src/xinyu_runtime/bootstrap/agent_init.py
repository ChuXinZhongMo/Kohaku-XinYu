...
from xinyu_runtime.bootstrap.io import create_input, create_output
from xinyu_runtime.bootstrap.llm import create_llm_provider
from xinyu_runtime.bootstrap.subagents import init_subagents
from xinyu_runtime.bootstrap.tools import init_tools
from xinyu_runtime.bootstrap.triggers import init_triggers
from xinyu_runtime.builtins.tool_catalog import get_builtin_tool
from xinyu_runtime.builtins.user_commands import (
    get_builtin_user_command,
    list_builtin_user_commands,
)
from xinyu_runtime.core.config import AgentConfig
from xinyu_runtime.core.controller import Controller, ControllerConfig
from xinyu_runtime.core.executor import Executor
from xinyu_runtime.core.loader import ModuleLoader
from xinyu_runtime.core.registry import Registry
from xinyu_runtime.core.session import get_session
from xinyu_runtime.modules.input.base import InputModule
from xinyu_runtime.modules.output.base import OutputModule
from xinyu_runtime.modules.output.router import OutputRouter
from xinyu_runtime.modules.subagent import SubAgentManager
from xinyu_runtime.modules.user_command.base import (
    UserCommandContext,
    UserCommandResult,
    parse_slash_command,
)
from xinyu_runtime.packages import (
    find_package_root_for_path,
    get_package_framework_hints,
)
from xinyu_runtime.parsing.format import BRACKET_FORMAT, XML_FORMAT, ToolCallFormat
from xinyu_runtime.prompt.aggregator import aggregate_system_prompt
from xinyu_runtime.prompt.framework_hints import merge_overrides
from xinyu_runtime.skills import (
    SkillCommand,
    SkillPathScanner,
    SkillRegistry,
...
from xinyu_runtime.utils.file_guard import FileReadState, PathBoundaryGuard
...
class AgentInitMixin:
    ...
    def _init_controller(self) -> None:
        ...
        # Resolve framework-hint overrides: package-level (xinyu.yaml)
