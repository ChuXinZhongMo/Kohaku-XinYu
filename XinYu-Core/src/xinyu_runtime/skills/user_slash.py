...
(:meth:`xinyu_runtime.modules.input.base.BaseInputModule._dispatch_skill_slash`)
...
:mod:`xinyu_runtime.modules.input.base` and
:mod:`xinyu_runtime.builtins.user_commands` (which indirectly depends
on the input module at agent init).
"""

from xinyu_runtime.skills.registry import Skill
