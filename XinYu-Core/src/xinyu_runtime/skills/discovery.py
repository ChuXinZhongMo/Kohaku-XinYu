...
2. user    (``~/.xinyu/skills``, ``~/.claude/skills``,
            ``~/.agents/skills``)
...
from xinyu_runtime.packages import get_package_path, list_packages
from xinyu_runtime.prompt.skill_loader import parse_frontmatter
