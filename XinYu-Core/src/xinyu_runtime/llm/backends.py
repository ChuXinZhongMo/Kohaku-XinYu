...
The single YAML file ``~/.xinyu/llm_profiles.yaml`` holds both
...
PROFILES_PATH = XINYU_CONFIG_DIR / "llm_profiles.yaml"
_SCHEMA_VERSION = 3
...
def _built_in_providers() -> dict[str, LLMBackend]:
    ...
    :class:`~xinyu_runtime.modules.tool.base.BaseTool` subclasses
