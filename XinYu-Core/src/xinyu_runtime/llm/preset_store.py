...
from xinyu_runtime.llm.profile_types import LLMBackend, LLMPreset
...
def load_presets() -> dict[tuple[str, str], LLMPreset]:
    ...
    :func:`xinyu_runtime.llm.profiles.save_profile` rewrites the
...
def serialize_user_data(
    ...
    """Produce the YAML payload for ``~/.xinyu/llm_profiles.yaml``."""
