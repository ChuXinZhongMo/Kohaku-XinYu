...
from xinyu_runtime.llm.base import (
    BaseLLMProvider,
    ChatResponse,
    NativeToolCall,
    ToolSchema,
...
from xinyu_runtime.llm.codex_image_gen import (
    build_image_part,
    translate_image_gen_tool,
)
from xinyu_runtime.llm.codex_rate_limits import (
...
def _maybe_capture_stream_rate_limit(event: Any) -> None:
    ...
    try:
        ...
        if snap is not None and snap.has_data():
            from xinyu_runtime.llm.codex_rate_limits import UsageSnapshot
