...
from xinyu_runtime.api.studio.codegen.common import (
    find_class,
    first_class,
    parse,
    read_method_body,
...
from xinyu_runtime.api.studio.templates_render import render
...
def _hook_context(h: dict) -> dict:
    ...
    from xinyu_runtime.api.studio.routes.catalog import PLUGIN_HOOKS
