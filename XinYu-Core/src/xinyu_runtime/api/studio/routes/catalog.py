...
from xinyu_runtime.api.studio.catalog_sources import (
    dedupe_preserve_order,
    package_entries,
    workspace_manifest_entries,
)
from xinyu_runtime.api.studio.deps import get_workspace_optional
from xinyu_runtime.api.studio.workspace.base import Workspace
from xinyu_runtime.builtin_skills import (
...
from xinyu_runtime.builtins.tool_catalog import get_builtin_tool, list_builtin_tools
from xinyu_runtime.llm.profiles import list_all as list_all_models
...
async def list_plugins(
    ...
    base); all discoverable plugins live in xinyu.yaml manifests.
    """
    out: list[dict] = []
...
async def list_inputs(
    ...
    xinyu.yaml uses ``io:`` for both inputs and outputs; classification
...
async def list_embedding_presets() -> dict:
    ...
    from xinyu_runtime.session.embedding import list_embedding_presets as _list
