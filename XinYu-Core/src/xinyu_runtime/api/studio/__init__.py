"""Studio backend 鈥?embedded authoring studio for XinYu Runtime.
...
``xinyu_runtime.serving`` 鈥?read-only dependencies documented in
``plans/kt-studio/architecture.md 搂9``.
"""
