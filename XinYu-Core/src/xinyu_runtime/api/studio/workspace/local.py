...
from xinyu_runtime.api.studio.utils.paths import ensure_in_root, sanitize_name
from xinyu_runtime.api.studio.yaml_io.creature import (
    load_creature_file,
...
class LocalWorkspace:
    ...
    def _modules_summary(self, kind: str) -> list[dict]:
        ...
        *inside* the workspace root are marked ``editable: true``.
        ...
        ``xinyu.yaml``; without this flag the dashboard would treat
        them as read-only.
        """
        merged: list[dict] = []
    ...
    def load_module(self, kind: str, name: str) -> dict:
        ...
        from xinyu_runtime.api.studio.codegen import get_codegen
    ...
    def save_module(self, kind: str, name: str, data: dict) -> dict:
        ...
        from xinyu_runtime.api.studio.codegen import RoundTripError, get_codegen
