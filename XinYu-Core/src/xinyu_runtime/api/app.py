...
from xinyu_runtime.api.deps import get_manager
from xinyu_runtime.api.routes import (
    agents,
    channels,
    configs,
    creatures,
...
from xinyu_runtime.api.studio import build_studio_router
from xinyu_runtime.api.ws import agents as ws_agents
from xinyu_runtime.api.ws import channels as ws_channels
from xinyu_runtime.api.ws import chat as ws_chat
from xinyu_runtime.api.ws import files as ws_files
from xinyu_runtime.api.ws import logs as ws_logs
from xinyu_runtime.api.ws import terminal as ws_terminal
...
def create_app(
    ...
    """
    app = FastAPI(
        title="XinYu Runtime API",
        description="HTTP API for managing XinYu agents and terrariums.",
        version="1.1.0",
        lifespan=lifespan,
    )
