...
# Status glyphs. Keep these ASCII so Windows consoles cannot corrupt the file.
ICON_RUNNING = ">"
ICON_DONE = "+"
ICON_ERROR = "!"
ICON_USER = "@"
...
# Gutter prefix for the marker that starts a tool body in the committed Panel.
GUTTER_GLYPH = "|"
GUTTER_INDENT = "  "
