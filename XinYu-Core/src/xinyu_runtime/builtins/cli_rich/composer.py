...
from xinyu_runtime.builtins.cli_rich.completer import SlashCommandCompleter
from xinyu_runtime.builtins.cli_rich.paste_store import (
    PasteStore,
...
HISTORY_DIR = xinyu_path("history")
