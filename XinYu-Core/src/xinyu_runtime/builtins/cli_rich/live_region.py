...
from xinyu_runtime.builtins.cli_rich.theme import (
    COLOR_AI,
    COLOR_BG,
...
class LiveRegion:
    ...
    def __init__(self):
        ...
        # The activity pulse (XinYu thinking) renders while EITHER is True
    ...
    def set_processing(self, value: bool) -> None:
        ...
        so the XinYu thinking pulse doesn't blink off while tools run.
        """
