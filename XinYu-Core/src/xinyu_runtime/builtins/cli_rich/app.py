...
from xinyu_runtime.builtins.cli_rich.app_output import AppOutputMixin
from xinyu_runtime.builtins.cli_rich.commit import ScrollbackCommitter, SessionReplay
from xinyu_runtime.builtins.cli_rich.composer import Composer
from xinyu_runtime.builtins.cli_rich.dialogs.model_picker import ModelPicker
from xinyu_runtime.builtins.cli_rich.dialogs.settings import SettingsOverlay
from xinyu_runtime.builtins.cli_rich.hint_bar import SlashHintBar
from xinyu_runtime.builtins.cli_rich.live_region import LiveRegion
from xinyu_runtime.builtins.cli_rich.runtime import (
    StderrToLogger,
...
from xinyu_runtime.builtins.cli_rich.theme import COLOR_BANNER
...
from xinyu_runtime.modules.user_command.base import parse_slash_command
...
class RichCLIApp(AppOutputMixin):
    ...
    def _print_banner(self) -> None:
        ...
        banner = Text()
        banner.append("XinYu Runtime", style=COLOR_BANNER)
