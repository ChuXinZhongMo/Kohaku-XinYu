...
from xinyu_runtime.builtins.inputs.cli import CLIInput, NonBlockingCLIInput
...
# Register TUI input
from xinyu_runtime.builtins.tui.input import TUIInput

register_builtin_input("tui", TUIInput)

# Try to register whisper (optional dependency)
try:
    from xinyu_runtime.builtins.inputs.whisper import WhisperASR, create_whisper_asr
