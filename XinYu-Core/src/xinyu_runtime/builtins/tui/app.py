"""AgentTUI - Textual application for the XinYu Runtime TUI."""
...
from xinyu_runtime.builtins.tui.widgets import (
    ChatInput,
    LoadOlderButton,
    QueuedMessage,
    RunningPanel,
...
class AgentTUI(App):
    """Textual app for XinYu Runtime agent interaction."""
    ...
    Header { background: $xinyu-iolite; color: white; }
    Footer { background: $xinyu-iolite 15%; }
    ...
    #quick-status { height: 1; color: $xinyu-amber; padding: 0 1; }
    ...
    def on_mount(self) -> None:
        self.title = f"XinYu Runtime - {self.agent_name}"
