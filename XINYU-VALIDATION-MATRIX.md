...
| Bridge renderer guard flags | `python -m py_compile xinyu_bridge_renderer.py bridge_renderer_guard_flags_smoke.py xinyu_core_bridge.py`; `bridge_renderer_guard_flags_smoke.py`; `xinyu_speech_controller_smoke.py`; focused final-guard pytest cases; `bridge_probe_smoke.py` |
