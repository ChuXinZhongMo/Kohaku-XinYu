...
- 主素材库位置：`D:\XinYu\素材库\心玉\表情`
- 未分类入口：`D:\XinYu\素材库\心玉\表情\待分类`
...
```text
D:\XinYu\素材库\心玉\表情\corrections.generated.json
```
...
```text
D:\XinYu\素材库\心玉\表情\参考图\调侃
D:\XinYu\素材库\心玉\表情\参考图\无语
D:\XinYu\素材库\心玉\表情\参考图\慌张
```
...
- Desktop 面板现在可以直接把表情记录拖到中文分类标签完成纠错；主进程会校验路径，只在 `D:\XinYu\素材库\心玉\表情` 内移动图片，并自动重建索引。
