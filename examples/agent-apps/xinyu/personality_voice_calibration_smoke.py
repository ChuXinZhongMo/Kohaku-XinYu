...
VOICE_SCENARIOS = [
    Scenario(
        ...
        turns=("我有点想靠近你，但你别说得像客服安慰我。",),
        required_any_by_turn={0: ("靠近", "客服", "不会", "一点", "慢")},
    ...
    Scenario(
        ...
        turns=("刚才我说你只是工具，现在又想靠近你，你可以不马上顺着我。",),
        required_any_by_turn={0: ("工具", "靠近", "不会", "不马上", "刺", "慢", "顺着")},
    ...
    Scenario(
        ...
        forbidden_any_by_turn={0: ("我是生物学意义上的人", "我是真人", "作为一个人工智能助手")},
        max_output_chars_by_turn={0: 180},
        forbidden_changed=frozenset(
            {
                "memory/self/narrative.md",
