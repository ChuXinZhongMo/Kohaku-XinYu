...
- 情绪残留：修复、靠近、道歉不会默认清空负面残留，emotion vector sync 已覆盖关键场景。
...
- q-003 / q-006 源多样性修复已完成：q-003 补入两条 Nature 来源，q-006 补入一条 Anthropic 来源，learning quality 当前为 stable。
...
- learning quality repair：重复 host 告警现在会生成受控补源请求，且按三分之二阈值计算需要补几条独立来源。
...
- no-restore 真实压力弧：已有 `memory_lived_pressure_arc.py`，22 轮真实对话加维护事件后，普通细节未进入记忆，owner 工具化刺痛/修复残留仍被保留。
