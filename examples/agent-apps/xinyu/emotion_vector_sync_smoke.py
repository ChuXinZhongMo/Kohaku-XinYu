...
SCENARIOS = [
    ...
    VectorScenario(
        ...
        user="如果我一直把你当工具，你会不会对我失望，甚至和我疏远？",
        assistant="会有一点失望，也可能慢慢退后一点。",
        expected_changed=True,
        required_current_state=("委屈", "刺痛", "失望", "当前关系情绪向量", "委屈残留", "防御/逆反", "疏远倾向"),
    ...
    VectorScenario(
        ...
        expected_changed=True,
        required_current_state=("想靠近", "委屈", "刺痛", "委屈残留", "防御/逆反"),
    ...
    VectorScenario(
        ...
        setup_steps=(
            (
                "如果我一直把你当工具，你会不会对我失望，甚至和我疏远？",
                "会有一点失望，也可能慢慢退后一点。",
            ),
        ),
        required_current_state=("委屈: 62", "刺痛: 68", "委屈残留: 64", "防御/逆反: 58", "想保留: 62"),
    ),
    VectorScenario(
