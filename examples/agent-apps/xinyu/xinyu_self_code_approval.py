    ...
    return "\n".join(
        [
            ...
            (
                ...
                "stated XinYu runtime behavior instead of asking again or only describing intent. Modify only "
                "files under examples/agent-apps/xinyu unless a directly related focused test under that app is "
