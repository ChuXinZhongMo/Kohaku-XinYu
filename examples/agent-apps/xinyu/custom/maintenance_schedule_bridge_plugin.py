...
def _trace(root: Path, line: str) -> None:
    trace_path = root / "memory/context/maintenance_schedule_trace.log"
                ...
                },
                {
                    ...
                    "trigger": SchedulerTrigger(
                        ...
                        prompt=(
                            ...
                            "source gate, source reliability, source integration gate, source request planner, source search resolver, autonomous search activation, source search provider, search result gate, outward source, source comparison, learner integration, learning quality, AI self-iteration gate, consolidation, long-term memory gate, retention gate, archive output, archive commit, personality growth gate, and inner cycle summary if continuity supports it. Do not treat this as a human speaking turn. "
